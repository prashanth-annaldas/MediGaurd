...
const useStore = create((set, get) => ({
    ...
    fetchPrediction: async (currentStats) => {
        try {
            ...
            const res = await fetch('http://localhost:8000/api/predict_shortage', {
                method: 'POST',
    ...
    clearAllAlerts: async () => {
        ...
        try {
            ...
            const url = hospitalName ? `http://localhost:8000/api/alerts?hospital_name=${encodeURIComponent(hospitalName)}` : 'http://localhost:8000/api/alerts';
