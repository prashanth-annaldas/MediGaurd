...
export default function AppointmentModal({ hospital, onClose }) {
    ...
    const handleExtract = async () => {
        ...
        setError(null);
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL || 'https://medigaurd1-fzd9.onrender.com'}`}/api/appointments/extract`, {
                method: 'POST',
    ...
    const handleBook = async () => {
        ...
        setError(null);
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL || 'https://medigaurd1-fzd9.onrender.com'}`}/api/appointments`, {
                method: 'POST',
                headers: {
