...
export default function AppointmentModal({ hospital, onClose }) {
    ...
    const handleExtract = async () => {
        ...
        setError(null);
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL || 'http://localhost:8000'}`}/api/appointments/extract`, {
                method: 'POST',
    ...
    const handleBook = async () => {
        ...
        setError(null);
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL || 'http://localhost:8000'}`}/api/appointments`, {
                method: 'POST',
                headers: {
